...
import Homework_10_solution as solution
...
def test_gdp_data_df(): #q3b
    """Test that the 'gdp_data_df' variable has been defined correctly
    in your notebook.
    """

    # Check that the variable exists in the notebook
    assert hasattr(hw, 'gdp_data_df'),\
            'We could not find a variable called "gdp_data_df" in your file.'

    # Make sure that the variable is a pandas DataFrame
    assert isinstance(hw.gdp_data_df, pd.DataFrame),\
        'Your gdp_data_df variable is incorrectly defined. It should refer to a Pandas DataFrame.'

    pd.testing.assert_frame_equal(hw.gdp_data_df, solution.gdp_data_df, obj="gdp_data_df")

def test_gdp_2020_df(): #q3b
    """Test that the 'gdp_2020_df' variable has been defined correctly
    in your notebook.
    """

    # Check that the variable exists in the notebook
    assert hasattr(hw, 'gdp_2020_df'),\
            'We could not find a variable called "gdp_2020_df" in your file.'

    # Make sure that the variable is a pandas DataFrame
    assert isinstance(hw.gdp_2020_df, pd.DataFrame),\
        'Your gdp_2020_df variable is incorrectly defined. It should refer to a Pandas DataFrame.'

    pd.testing.assert_frame_equal(hw.gdp_2020_df, solution.gdp_2020_df, obj="gdp_2020_df")

def test_countries_gdf(): #q3b
    """Test that the 'countries_gdf' variable has been defined correctly
    in your notebook.
    """

    # Check that the variable exists in the notebook
    assert hasattr(hw, 'countries_gdf'),\
            'We could not find a variable called "countries_gdf" in your file.'

    # Make sure that the variable is a pandas DataFrame
    assert isinstance(hw.countries_gdf, gpd.GeoDataFrame),\
        'Your countries_gdf variable is incorrectly defined. It should refer to a GeoPandas GeoDataFrame.'

    pd.testing.assert_frame_equal(hw.countries_gdf, solution.countries_gdf, obj="countries_gdf")

def test_countries_gdp_gdf(): #q3b
    """Test that the 'countries_gdp_gdf' variable has been defined correctly
    in your notebook.
    """

    # Check that the variable exists in the notebook
    assert hasattr(hw, 'countries_gdp_gdf'),\
            'We could not find a variable called "countries_gdp_gdf" in your file.'

    # Make sure that the variable is a pandas DataFrame
    assert isinstance(hw.countries_gdp_gdf, gpd.GeoDataFrame),\
        'Your countries_gdp_gdf variable is incorrectly defined. It should refer to a GeoPandas GeoDataFrame.'

    pd.testing.assert_frame_equal(hw.countries_gdp_gdf, solution.countries_gdp_gdf, obj="countries_gdp_gdf")
